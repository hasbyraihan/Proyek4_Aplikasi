...
class AdminEditDokumentasiRW extends StatefulWidget {
  final String title;

  const AdminEditDokumentasiRW({Key? key, required this.title})
      : super(key: key);

  @override
  _AdminEditDokumentasiRWState createState() => _AdminEditDokumentasiRWState();
}

class _AdminEditDokumentasiRWState extends State<AdminEditDokumentasiRW> {
  ...
  Future<void> _uploadImage() async {
    ...
    try {
      ...
      final storageReference = FirebaseStorage.instance.ref().child(
          'info-desa/kebutuhan-rw/${widget.title}/dokumentasi/fasilitas/${DateTime.now().millisecondsSinceEpoch}.jpg');
